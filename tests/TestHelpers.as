...
void Test_AppendQueryParam_Basic(TestHelpers::TestContext &inout ctx) {
    ...
    string res1 = Helpers::AppendQueryParam(url1, "test", "1");
    ctx.AssertEqual("https://example.com/path?test=1", res1, "append when no query exists");

    string url2 = "https://example.com/path?bar=2";
    string res2 = Helpers::AppendQueryParam(url2, "test", "1");
    ctx.AssertEqual("https://example.com/path?bar=2&test=1", res2, "append to an existing query");

    string url3 = "https://example.com/path?test=9";
    string res3 = Helpers::AppendQueryParam(url3, "test", "1");
...
void Test_AppendQueryParam_EdgeCases(TestHelpers::TestContext &inout ctx) {
    ...
    string res1 = Helpers::AppendQueryParam(url1, "test", "1");
    ctx.AssertEqual("https://example.com/path?test=1#anchor", res1, "should preserve fragment");

    string url2 = "https://example.com/path?test=9#x";
    string res2 = Helpers::AppendQueryParam(url2, "test", "1");
...
// Entry point to run the test suite from outside.
